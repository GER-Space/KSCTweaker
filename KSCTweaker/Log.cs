...
namespace KSCTweaker
{
    internal class Log
    {
        ...
        {
            UnityEngine.Debug.Log("KSCTweaker: " + message);
        }
        ...
        {
            UnityEngine.Debug.LogWarning("KSCTweaker: " + new StackFrame(1, true).GetMethod().Name + ": " + message);
        }
        ...
        {
            UnityEngine.Debug.LogError("KSCTweaker: " + new StackFrame(1, true).GetMethod().Name + ": " + message);
        }
        ...
        {
#if DEBUG
            UnityEngine.Debug.Log("KSCTweaker: " + new StackFrame(1, true).GetMethod().Name + ": " + message);
#endif
        }
